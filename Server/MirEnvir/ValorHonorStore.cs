namespace Server.MirEnvir
{
    ...
    public sealed class ValorHonorStore
    {
        public int Get(int characterIndex)
        {
            ...
            if (info == null) throw new InvalidOperationException("Valor character record is unavailable.");
        ...
        public void SetMany(Dictionary<int, int> changes)
        {
            ...
            if (records.Any(p => p.Info == null)) throw new InvalidOperationException("Valor character record is unavailable.");
